...
const Footer = () => {
  ...
  return (
    <footer className='ph4 pt4 pb5 bt b--black-10 cf'>
      <a href={tweetUrl} className='dib ml3-ns fr-ns dim f6 ttu fw6 link mb4 twitter-share-button bg-blue white br1 ph3 pv2' data-via='mrmrs_' data-size='large'>Tweet This</a>
