...
const Combination = ({ colorOne, colorTwo }) => (
  <section className='pb5 mb0 mw6 center flex' style={{ backgroundColor: colorTwo }}>
    <div className='w-50 pv4' style={{ backgroundColor: colorTwo, color: colorOne }}>
      ...
      <div className='pl4 pv4 w-100'>
        <h4 className='mb2 mt0 f5 f4-ns'>{namer(colorOne).pantone[0].name}</h4>
    ...
    <div className='w-50 pv4'>
      ...
      <div className='pa4 w-100' style={{ backgroundColor: colorOne, color: colorTwo }}>
